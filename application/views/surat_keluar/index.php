                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr class="gradeA odd" role="row">
                                                            ...
                                                            <td class="center">
                                                                ...
                                                                <a href="<?= base_url('surat_keluar/disposisi/') ?>" type="button" class="btn btn-info"><i class="fa  fa-location-arrow fa-fw"></i> Kirim</a>
                                                                <a href="<?= base_url('surat_keluar/edit/') ?>" type="button" class="btn btn-warning"><i class="fa fa-edit fa-fw"></i>Edit</a>
                                                                <a href="<?= base_url('surat_keluar/hapus/') ?>" type="button" class="btn btn-danger"><i class="fa fa-trash fa-fw"></i>Hapus</a>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
